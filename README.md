...
- frontend/ - React UI
- database.sql - SQL Server schema, procedures, triggers, and seed data
...
3. Run the SQL script at `database.sql` to create tables, procedures, triggers, and seed data.
